...
export async function scanInvoiceAction(
  ...
  try {
    ...
    // gemini-2.0-flash: 1,500 req/day free tier — best available for OCR on a free key
    // gemini-1.5-pro:  50 req/day free tier   — exhausted quickly in testing
    // gemini-2.5-pro:  0 req/day free tier    — paid plans only
